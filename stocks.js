export const STOCKS = [
  ...
  // ===== JAPAN =====
  {s:"7203.T", n:"Toyota"}, {s:"6758.T", n:"Sony"}, {s:"9984.T", n:"SoftBank"},
  {s:"6861.T", n:"Keyence"},
  ...
  // ===== ADDITIONAL TO MAKE 160 =====
  {s:"ADP", n:"ADP"}, {s:"MMM", n:"3M"}, {s:"UPS", n:"UPS"}, {s:"FDX", n:"FedEx"},
  {s:"LVS", n:"Las Vegas Sands"}, {s:"MAR", n:"Marriott"}, {s:"BKNG", n:"Booking Holdings"},
  {s:"EXPE", n:"Expedia"}, {s:"EA", n:"Electronic Arts"}, {s:"ATVI", n:"Activision Blizzard"},
  {s:"NFLX", n:"Netflix"}, {s:"DIS", n:"Disney"}, {s:"SONY", n:"Sony Corp"},
  {s:"SNE", n:"Sony Entertainment"}, {s:"ZM", n:"Zoom"}, {s:"DOCU", n:"DocuSign"},
  {s:"WORK", n:"Slack Technologies"}, {s:"SNAP", n:"Snap"}, {s:"TWTR", n:"Twitter"},
  {s:"PINS", n:"Pinterest"}, {s:"UBER", n:"Uber"}, {s:"LYFT", n:"Lyft"}, {s:"SQ", n:"Square"},
  {s:"PYPL", n:"PayPal"}, {s:"SHOP", n:"Shopify"}, {s:"TWLO", n:"Twilio"}, {s:"CRM", n:"Salesforce"},
  {s:"ADBE", n:"Adobe"}, {s:"CSCO", n:"Cisco"}, {s:"INTC", n:"Intel"}, {s:"QCOM", n:"Qualcomm"}
];

// Funktion um Aktien in das Select einzufügen
export function initializeStocks(select) {
  STOCKS.forEach(a => {
